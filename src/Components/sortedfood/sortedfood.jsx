...
function SortedFood() {
  ...
  useEffect(() => {
    axios
      .get(`http://13.251.119.140:3001/food/type/${type}`)
      .then((response) => {
  ...
  // Function to sort food by calories
  const sortFoodByCalories = () => {
    const sortedFood = [...sortedFoods].sort((a, b) => {
      if (sortOrder === "asc") {
      ...
      <div className="flex justify-between items-center my-5">
        ...
        >
          ...
          <div className="relative">
            ...
            <button
              type="submit"
              className="text-white absolute end-2.5 bottom-2.5 bg-black hover:bg-[#D3A121]  hover:text-black font-medium rounded-lg text-sm px-4 py-2 "
            >
              Search
            </button>
          </div>
          ...
          >
            ...
            >
              ...
              <div className="p-4 bg-white">
                ...
                <div className="flex flex-wrap justify-center text-center ml-28 text-yellow-600">
